...
public interface BlameController {
    public void postBlame(@RequestParam("postId") @Positive(message = "{invalid.request}") Long postId, @RequestBody @Valid String reason, HttpServletRequest request);
    public void commentBlame(@RequestParam("commentId") @Positive(message = "{invalid.request}") Long commentId, @RequestBody @Valid String reason, HttpServletRequest request);
